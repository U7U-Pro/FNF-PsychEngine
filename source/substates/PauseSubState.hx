...
class PauseSubState extends MusicBeatSubstate
{
	...
	override function create()
	{
		...
		chartingText.setFormat(Paths.font('mingliu.ttf'), 32);
		...
		missingText.setFormat(Paths.font("mingliu.ttf"), 24, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	function regenMenu():Void {
		...
		for (i in 0...menuItems.length) {
			...
			if(menuItems[i] == 'Skip Time')
			{
				...
				skipTimeText.setFormat(Paths.font("mingliu.ttf"), 64, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
