...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if (isStoryMode)
			detailsText = "Story Mode: Beef"; //+ WeekData.getCurrentWeek().weekName;
		else
		...
		switch (curStage)
		{
			...
			case 'beef3': new states.stages.Beef3();
		}
		...
		timeTxt = new Alphabet(STRUM_X + (FlxG.width / 2) - 248, 19, "", false, 'fartnumbers');
		/*for (letter in timeTxt.letters)
			letter.image = 'fartnumbers';*/
		...
		{ fuck this specific piece of code
			timeTxt.size = 24;
			timeTxt.y += 3;
		}*/ 
		...
		botplayTxt = new FlxText(400, timeBar.y + 55, FlxG.width - 800, "dick sucker", 32);
		botplayTxt.setFormat(Paths.font("mingliu.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	public var countdownLife:FlxSprite;
	public var countdownOr:FlxSprite;
	public var countdownDeath:FlxSprite;
	public var countdownSuffer:FlxSprite;
	...
	function cacheCountdown()
	{
		...
		var introImagesArray:Array<String> = switch(stageUI) {
			...
			case "normal": ["startupLIFE", "startupOR" ,"startupDEATH", "startupSUFFER"];
	...
	public function startCountdown()
	{
		...
		if(ret != LuaUtils.Function_Stop) {
			...
			startTimer = new FlxTimer().start(Conductor.crochet / 1000 / playbackRate, function(tmr:FlxTimer)
			{
				...
				{
					case 0:
						countdownLife = createCountdownSprite(introAlts[0], antialias);
						FlxG.sound.play(Paths.sound('intro3' + introSoundsSuffix), 0.6);
						tick = THREE;
					case 1:
						countdownOr = createCountdownSprite(introAlts[1], antialias);
						FlxG.sound.play(Paths.sound('intro2' + introSoundsSuffix), 0.6);
						tick = TWO;
					case 2:
						countdownDeath = createCountdownSprite(introAlts[2], antialias);
						FlxG.sound.play(Paths.sound('intro1' + introSoundsSuffix), 0.6);
						tick = ONE;
					case 3:
						countdownSuffer = createCountdownSprite(introAlts[3], antialias);
